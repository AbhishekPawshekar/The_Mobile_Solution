...
public class deleteproduct_select_categoryadapter extends FirestoreRecyclerAdapter<seemoreretriveclass, deleteproduct_select_categoryadapter.myholder> {
        public deleteproduct_select_categoryadapter(@NonNull FirestoreRecyclerOptions<seemoreretriveclass> options) {
            super(options);
        }
...
String both=model.getCategory_Name();
            ...
            holder.cd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i=new Intent(v.getContext(),deleteproduct.class);
                    i.putExtra("category_name1",model.getCategory_Name());
